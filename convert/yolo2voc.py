...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--anno-path",
        type=str,
        default="/home/wjh/code/yolov7/runs/detect/exp28/labels",
        help="yolo txt path",
    )
    parser.add_argument(
        "-s",
        "--save-path",
        type=str,
        default="/home/wjh/code/yolov7/runs/detect/exp28/voc",
        help="xml save path",
    )
    parser.add_argument("--image-path", default="/home/wjh/code/yolov7/runs/detect/exp28/Images")
    ...
    if len(sys.argv) > 1:
        ...
        anno_path = "/home/wjh/code/yolov7/runs/detect/exp28/labels"
        save_path = "/home/wjh/code/yolov7/runs/detect/exp28/Annotations"
        image_path = "/home/wjh/code/yolov7/runs/detect/exp28/Images"
